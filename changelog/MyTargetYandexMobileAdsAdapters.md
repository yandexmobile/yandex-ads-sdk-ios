...
- Updated minimum supported `myTargetSDK` version to `5.37.5`
...
- Updated minimum supported `myTargetSDK` version to `5.28.0`
...
- Updated minimum supported `myTargetSDK` version to `5.26.0`
